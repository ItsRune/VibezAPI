...
## Implementation
First things first, you'll need to [download it here.](https://drive.google.com/uc?export=download&id=1wWXkv_L674LzPKKBvVsHvzO5ar_L8zSX) Once you've done that, you'll need to open the file and publish to your group as a new game. Afterwards you're ready to customize it to your liking.
